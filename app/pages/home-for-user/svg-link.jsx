...
const SVGLink = React.createClass({
  ...
  inject() {
    Array.prototype.forEach.call(this.link.attributes, (attribute) => {
      attribute && this.link.removeAttribute(attribute.name);  //In IE11, sometimes attribute is undefined
    });
  ...
  backToNormal() {
    if (!this.link) return;  //In IE11, this.link is sometimes undefined
